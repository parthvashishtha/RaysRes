...
var _chunkA3OZNHPEcjs = require('./chunk-A3OZNHPE.cjs');
...
var Oas = class _Oas {
  ...
  operation(path, method, opts = {}) {
    ...
    if (opts.isWebhook) {
      ...
      if (_optionalChain([api, 'optionalAccess', _7 => _7.webhooks, 'access', _8 => _8[path], 'optionalAccess', _9 => _9[method]])) {
        ...
        return new (0, _chunkA3OZNHPEcjs.Webhook)(api, path, method, operation);
      }
    }
    ...
    return new (0, _chunkA3OZNHPEcjs.Operation)(this.api, path, method, operation);
  }
  ...
  getTags(setIfMissing = false) {
    ...
    const disableTagSorting = _chunkXWUEF5DOcjs.getExtension.call(void 0, "disable-tag-sorting", this.api);
  ...
  hasExtension(extension) {
    return _chunkXWUEF5DOcjs.hasRootExtension.call(void 0, extension, this.api);
  }
  /**
  ...
  getExtension(extension, operation) {
    return _chunkXWUEF5DOcjs.getExtension.call(void 0, extension, this.api, operation);
  }
  /**
  ...
  validateExtension(extension) {
    if (this.hasExtension("x-readme")) {
      ...
      if (extension in data) {
        if ([_chunkXWUEF5DOcjs.CODE_SAMPLES, _chunkXWUEF5DOcjs.HEADERS, _chunkXWUEF5DOcjs.PARAMETER_ORDERING, _chunkXWUEF5DOcjs.SAMPLES_LANGUAGES].includes(extension)) {
          if (!Array.isArray(data[extension])) {
            throw new TypeError(`"x-readme.${extension}" must be of type "Array"`);
          }
          if (extension === _chunkXWUEF5DOcjs.PARAMETER_ORDERING) {
            _chunkXWUEF5DOcjs.validateParameterOrdering.call(void 0, data[extension], `x-readme.${extension}`);
          }
    ...
    if (this.hasExtension(`x-${extension}`)) {
      ...
      if ([_chunkXWUEF5DOcjs.CODE_SAMPLES, _chunkXWUEF5DOcjs.HEADERS, _chunkXWUEF5DOcjs.PARAMETER_ORDERING, _chunkXWUEF5DOcjs.SAMPLES_LANGUAGES].includes(extension)) {
        ...
        if (extension === _chunkXWUEF5DOcjs.PARAMETER_ORDERING) {
          _chunkXWUEF5DOcjs.validateParameterOrdering.call(void 0, data, `x-${extension}`);
        }
   ...
   */
  validateExtensions() {
    Object.keys(_chunkXWUEF5DOcjs.extensionDefaults).forEach((extension) => {
  ...
  async dereference(opts = { preserveRefAsJSONSchemaTitle: false }) {
    ...
    if (api && api.components && api.components.schemas && typeof api.components.schemas === "object") {
      Object.keys(api.components.schemas).forEach((schemaName) => {
        if (_chunkVJPJCQC3cjs.isPrimitive.call(void 0, api.components.schemas[schemaName]) || Array.isArray(api.components.schemas[schemaName]) || api.components.schemas[schemaName] === null) {
          return;
        }
...
exports.Oas = Oas;
//# sourceMappingURL=chunk-PGOMVKMR.cjs.map